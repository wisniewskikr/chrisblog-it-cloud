...
##### Goal
The goal of this project is to present how to implement **Spring Cloud Gateway** in microservices system in **Java** programming language with usage **Spring Boot Cloud** framework.
