...
1. Check distributed tracking service Zipkin with `http://localhost:9411`
...
* **Service HelloWorld FE**: port **8080**. This service displays message, port FE, port BE, uuid FE and uuid BE
* **Service HelloWorld BE**: port **9090**. This service provides message, port BE and uuid BE
...
1. Service HelloWorld FE sends request to Service BE for content
1. Service HelloWorld BE sends back response to Service FE with message, port Be and uuid BE
1. Service HelloWorld sends back response to Service Gateway with message, ports and uuids. It sends also information about traffic to service Zipkin
1. Service Gateway sends back response to User via Browser with message, ports and uuids. It sends also information abotu traffic to service Zipkin
