...
##### Goal
The goal of this project is to present how to implement **microservices** in **Java** programming language with usage **Spring Boot Cloud** framework. Logs from specific microservices should be stored in one place. It should be handled by **elastic stack** - tool **elasticsearch** (database) + tool **kibana** (dashboard) + tool **logstash** (pipelines). 
...
1. Visit Gateway with `http://localhost:8762`
...
![My Image](elastic-1.png)

![My Image](elastic-2.png)

![My Image](elastic-3.png)

![My Image](elastic-4.png)

![My Image](elastic-5.png)

![My Image](elastic-6.png)