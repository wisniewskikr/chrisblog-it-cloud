...
##### Required steps:
1. In a first command line tool **start Second application** with `mvn -f ./springcloud-springboot3-intgrtests-restclient_SECOND spring-boot:run`
1. In a second command line tool **start First application** with `mvn -f ./springcloud-springboot3-intgrtests-restclient_FIRST spring-boot:run`
...
1. Clean up environment
   * In the second command line tool **stop First application** with `ctrl + C`
   * In the first command line tool **stop Second application** with `ctrl + C`
...
1. In a command line tool build Docker FIRST image with `docker build -f springcloud-springboot3-intgrtests-restclient_FIRST/Dockerfile -t wisniewskikr/springcloud-springboot3-intgrtests-restclient_first:0.0.1 ./springcloud-springboot3-intgrtests-restclient_FIRST`
1. In a command line tool push Docker FIRST image to Docker Repository with `docker push wisniewskikr/springcloud-springboot3-intgrtests-restclient_first:0.0.1`  
