...
1. In the second command line tool **start Discovery application** with `mvn -f ./springcloud-fe-thymeleaf-be-springboot-db-sql-mysql-gateway_DISCOVERY spring-boot:run`
...
1. In a command line tool build **Docker image DISCOVERY** with `docker build -f springcloud-fe-thymeleaf-be-springboot-db-sql-mysql-gateway_DISCOVERY/Dockerfile -t discovery-image:0.0.1 ./springcloud-fe-thymeleaf-be-springboot-db-sql-mysql-gateway_DISCOVERY`
...
##### Optional steps:
1. In a command line tool build Docker DISCOVERY image with `docker build -f springcloud-fe-thymeleaf-be-springboot-db-sql-mysql-gateway_DISCOVERY/Dockerfile -t wisniewskikr/springcloud-fe-thymeleaf-be-springboot-db-sql-mysql-gateway_discovery:0.0.1 ./springcloud-fe-thymeleaf-be-springboot-db-sql-mysql-gateway_DISCOVERY`
1. In a command line tool push Docker DISCOVERY image to Docker Repository with `docker push wisniewskikr/springcloud-fe-thymeleaf-be-springboot-db-sql-mysql-gateway_discovery:0.0.1`
