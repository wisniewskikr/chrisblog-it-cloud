...
##### Goal
The goal of this project is to present how to implement **microservices** in **Java** programming language with usage **Spring Boot Cloud** framework. This project contains **multiple** Hello World custom services which communicate each other using **feign** library. Communication between services handles **load balancing** - traffic is redirected to different instances of the same service alternately.
