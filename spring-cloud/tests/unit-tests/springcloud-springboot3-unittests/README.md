...
##### Optional steps:
1. In a command line tool build Docker SECOND image with `docker build -f springcloud-springboot3-unittests_SECOND/Dockerfile -t wisniewskikr/springcloud-springboot3-unittests_second:0.0.1 ./springcloud-springboot3-unittests_SECOND`
1. In a command line tool push Docker SECOND image to Docker Repository with `docker push wisniewskikr/springcloud-springboot3-unittests_second:0.0.1` 
1. In a command line tool build Docker FIRST image with `docker build -f springcloud-springboot3-unittests_FIRST/Dockerfile -t wisniewskikr/springcloud-springboot3-unittests_first:0.0.1 ./springcloud-springboot3-unittests_FIRST`
1. In a command line tool push Docker FIRST image to Docker Repository with `docker push wisniewskikr/springcloud-springboot3-unittests_first:0.0.1`  
