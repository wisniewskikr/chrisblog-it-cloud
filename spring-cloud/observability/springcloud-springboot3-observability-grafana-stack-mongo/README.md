...
1. In a command line tool build **Docker image BE** with `docker build -f springcloud-springboot3-observability-grafana-stack-mongo_BE/Dockerfile -t be-image:0.0.1 ./springcloud-springboot3-observability-grafana-stack-mongo_BE`
...
1. In a command line tool build **Docker image FE** with `docker build -f springcloud-springboot3-observability-grafana-stack-mongo_FE/Dockerfile -t fe-image:0.0.1 ./springcloud-springboot3-observability-grafana-stack-mongo_FE`
...
##### Optional steps:
1. In a command line tool build Docker BE image with `docker build -f springcloud-springboot3-observability-grafana-stack-mongo_BE/Dockerfile -t wisniewskikr/springcloud-springboot3-observability-grafana-stack-mongo_be:0.0.1 ./springcloud-springboot3-observability-grafana-stack-mongo_BE`
1. In a command line tool push Docker BE image to Docker Repository with `docker push wisniewskikr/springcloud-springboot3-observability-grafana-stack-mongo_be:0.0.1` 
1. In a command line tool build Docker FE image with `docker build -f springcloud-springboot3-observability-grafana-stack-mongo_FE/Dockerfile -t wisniewskikr/springcloud-springboot3-observability-grafana-stack-mongo_fe:0.0.1 ./springcloud-springboot3-observability-grafana-stack-mongo_FE`
1. In a command line tool push Docker FE image to Docker Repository with `docker push wisniewskikr/springcloud-springboot3-observability-grafana-stack-mongo_fe:0.0.1` 
