...
1. Build Service Display image with **docker build -f service-display/Dockerfile-Fast -t {hub-docker-id}/service-display-image ./service-display** . For instance with `docker build -f service-display/Dockerfile-Fast -t wisniewskikr/springcloud-network-kubernetes-service-display-image ./service-display`
1. Push Service Display image with **docker push {hub-docker-id}/springcloud-network-kubernetes-service-display-image** . For instance with `docker push wisniewskikr/springcloud-network-kubernetes-service-display-image`
1. Build Service Storage image with **docker build -f service-storage/Dockerfile-Fast -t {hub-docker-id}/service-storage-image ./service-storage** . For instance with `docker build -f service-storage/Dockerfile-Fast -t wisniewskikr/springcloud-network-kubernetes-service-storage-image ./service-storage`
1. Push Service Storage image with **docker push {hub-docker-id}/springcloud-network-kubernetes-service-storage-image** . For instance with `docker push wisniewskikr/springcloud-network-kubernetes-service-storage-image`
...
1. Clean up environment:
    ...
    * Remove Service Discovery image with **docker rmi {hub-docker-id}/{image-name}**. For instance with `docker rmi springcloud-network-kubernetes-service-discovery-image`
    ...
    * Remove Service Display image with **docker rmi {hub-docker-id}/{image-name}**. For instance with `docker rmi wisniewskikr/springcloud-network-kubernetes-service-display-image`
    * Remove Service Display image with name **{image-name}** from your **hub-docker-id** remote repository `https://hub.docker.com`. For instance `springcloud-network-kubernetes-service-display-image`    
    * Remove Service Storage image with **docker rmi {hub-docker-id}/{image-name}**. For instance with `docker rmi wisniewskikr/springcloud-network-kubernetes-service-storage-image`
    * Remove Service Storage image with name **{image-name}** from your **hub-docker-id** remote repository `https://hub.docker.com`. For instance `springcloud-network-kubernetes-service-storage-image`