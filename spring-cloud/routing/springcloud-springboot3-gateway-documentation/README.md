...
1. In a second command line tool **start Second application** with `mvn -f ./springcloud-springboot3-gateway-documentation_SECOND spring-boot:run`
1. In a third command line tool **start First application** with `mvn -f ./springcloud-springboot3-gateway-documentation_FIRST spring-boot:run`
...
##### Optional steps:
1. In a command line tool build Docker SECOND image with `docker build -f springcloud-springboot3-gateway-documentation_SECOND/Dockerfile -t wisniewskikr/springcloud-springboot3-gateway-documentation_second:0.0.1 ./springcloud-springboot3-gateway-documentation_SECOND`
1. In a command line tool push Docker SECOND image to Docker Repository with `docker push wisniewskikr/springcloud-springboot3-gateway-documentation_second:0.0.1` 
1. In a command line tool build Docker FIRST image with `docker build -f springcloud-springboot3-gateway-documentation_FIRST/Dockerfile -t wisniewskikr/springcloud-springboot3-gateway-documentation_first:0.0.1 ./springcloud-springboot3-gateway-documentation_FIRST`
1. In a command line tool push Docker FIRST image to Docker Repository with `docker push wisniewskikr/springcloud-springboot3-gateway-documentation_first:0.0.1`  
